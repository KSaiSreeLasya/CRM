...
const DashboardAP = () => {
  ...
  const fetchStats = async () => {
    try {
      ...
      console.error('Error fetching AP stats:', e);
    } finally {
      setIsLoading(false);
    }
  };
    ...
    return (
      <Box display="flex" justifyContent="center" alignItems="center" height="70vh">
        <VStack spacing={6}>
          ...
          <Text fontSize="lg" color="gray.600">Loading AP dashboard...</Text>
        ...
        <Card bg={cardBg} shadow="sm" border="1px solid" borderColor="gray.100">
          <CardHeader>
            <Flex justify="space-between" align="center">
              <Box>
                <Heading size="md" color="gray.800">Active Projects (AP)</Heading>
